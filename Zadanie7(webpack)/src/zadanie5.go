...
func createLocalhost() {
	...
	http.HandleFunc("/frond.ts", localjs)
	http.HandleFunc("/ws", wsLocal)
}

// local - сервер с соединение HTTP
func local(w http.ResponseWriter, r *http.Request) {
	http.ServeFile(w, r, "/home/vitaliy/awesomeProject/Create/Zadanie_webpack/src/zadanie5.html")
}

// localjs - выгружаем JS файл
func localjs(w http.ResponseWriter, r *http.Request) {
	http.ServeFile(w, r, "/home/vitaliy/awesomeProject/Create/Zadanie_webpack/src/frond.ts")
}
